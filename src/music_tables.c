...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_KRIS] = {0xFFFF, SEQ_GS_VS_TRAINER},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    // (***END OF VANILLA ENTRIES***)
    {TRAINERCLASS_PKMN_TRAINER_DAWN_DP, ANIM_MUSIC_COMBO_KRIS*4},
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_PKMN_TRAINER_DAWN_DP, .music1 = SEQ_GS_E_G_PICHU, .music2 = SEQ_GS_E_G_PICHU},
};
